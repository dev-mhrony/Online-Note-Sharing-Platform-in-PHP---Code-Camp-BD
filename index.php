                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-7 col-md-12">
                                <div class="hero__caption">
                                    <h1 data-animation="fadeInLeft" data-delay="0.3s">Online Note Shareing<br> Platform</h1>
                ...
                <div class="row justify-content-sm-center">
                    <div class="col-lg-4 col-md-6 col-sm-8">
                        <div class="single-services mb-30">
                            ...
                            <figure class="alignleft size-large is-resized"><img src="https://simplenote.com/wp-content/uploads/2020/07/ic_cloud-sync.png?w=72" alt="" class="wp-image-381" width="32" height="32"></figure>
                            </div>
